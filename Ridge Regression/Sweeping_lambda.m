...
X = csvread('/Users/sriramreddy/Downloads/ML/2/trainData.csv',0,0);
Y = csvread('/Users/sriramreddy/Downloads/ML/2/trainLabels.csv',0,0);
Z = transpose(X(:,2:end));
Y_b = Y(:,2:end);
K=size(Z);
K=K(1,1);
...
l_CE=[];
l_Kfold=[];
for lambda= [0.01, 0.1, 1, 10, 100, 1000]
%     linspace(0.5,0.7,10)
